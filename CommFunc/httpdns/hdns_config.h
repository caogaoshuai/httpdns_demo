...
HDNS_API hdns_config_t* hdns_config_create();

HDNS_API hdns_status_t hdns_config_valid(hdns_config_t* config);

HDNS_API void hdns_config_cleanup(hdns_config_t* config);

HDNS_API hdns_list_head_t* hdns_config_get_boot_servers(hdns_config_t* config, bool ipv4);
