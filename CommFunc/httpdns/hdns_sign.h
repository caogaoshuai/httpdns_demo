...
HDNS_API hdns_sign_t* hdns_gen_resv_req_sign(hdns_pool_t* pool, const char* host, const char* secret);

HDNS_API hdns_sign_t* hdns_gen_sched_req_sign(hdns_pool_t* pool, const char* nonce, const char* secret);
