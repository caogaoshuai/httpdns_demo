...
#ifndef BUILD_STATIC
# ifdef _MSC_VER
#  ifdef HTTPDNS_EXPORTS
#   define HDNS_API __declspec(dllexport)
#  else
#   define HDNS_API __declspec(dllimport)
#  endif
# else
#  define HDNS_API __attribute__((visibility("default")))
# endif
#else
# define HDNS_API
#endif
...
#define hdns_table_add_int(t, key, value)									\
do {																		\
	char value_str[64];														\
...
#define hdns_table_add_int64(t, key, value)									\
do {																		\
	char value_str[64];														\
...
#define hdns_table_set_int64(t, key, value)									\
do {																		\
	char value_str[64];														\
	apr_snprintf(value_str, sizeof(value_str), "%" APR_INT64_T_FMT, value);	\
...
#define hdns_str_is_blank(str)				((NULL == str || strlen(str) <= 0))

#define hdns_str_is_not_blank(str)			(NULL != str && strlen(str) > 0)

#define hdns_pool_new(p)					hdns_pool_t *p = NULL;hdns_pool_create(&p, NULL)

#define hdns_pool_new_with_pp(p, pp)		hdns_pool_t *p = NULL;hdns_pool_create(&p, pp)
