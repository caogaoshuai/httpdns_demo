...
HDNS_API hdns_net_detector_t* hdns_net_detector_create(apr_thread_pool_t* thread_pool);

HDNS_API void hdns_net_detector_stop(hdns_net_detector_t* detector);

HDNS_API void hdns_net_detector_cleanup(hdns_net_detector_t* detector);

HDNS_API void hdns_net_add_chg_cb_task(hdns_net_detector_t* detector, hdns_net_chg_cb_type_t type, hdns_net_chg_cb_fn_t fn, void* param, void* owner);

HDNS_API void hdns_net_cancel_chg_cb_task(hdns_net_detector_t* detector, void* owner);

HDNS_API void hdns_net_add_speed_detect_task(hdns_net_detector_t* detector, hdns_net_speed_cb_fn_t fn, void* param, hdns_list_head_t* ips, int port, void* owner, hdns_state_e* owner_state);

HDNS_API hdns_net_type_t hdns_net_get_type(hdns_net_detector_t* detector);

HDNS_API bool hdns_net_is_changed(hdns_net_detector_t* detector);
